...
- My CIDR IP block list is meant to function as a nice baseline for individuals and very small organizations that run public-facing servers. I have found this list to be quite effective at preventing waves of intrusion attempts while running public IceCast or Shoutcast servers, and DNS resolvers. If you're dealing with a larger amount of traffic on a 24/7 basis - especially international traffic - you will likely want to supplement this list with more aggressive bogon filtering and region-specific data.
...
<sub>These are simply my preferences. There are other fine resolvers out there, but I love the reliability of AdGuard and Quad9, along with the enormous amount of configurability that Rethink and DNS Warden offer. All four of these resolvers have fine privacy policies that range from minimal logging, to no logging at all. Thanks to some work projects over the past year, I have also become deeply familiar with the [PowerDNS stack](https://www.powerdns.com/), and can confidently recommend their software to anyone who is interested in rolling their own resolver (so long as they're not afraid of reading documentation). [DNSDist](https://www.powerdns.com/powerdns-dnsdist) in particular, is extremely impressive, but their [Auth Server](https://www.powerdns.com/powerdns-authoritative-server) and [Recursor](https://www.powerdns.com/powerdns-recursor) are stellar as well. In very rare circumstances when I cannot use a public or personal encrypted DNS resolver, I tend toward [OpenNIC](https://www.opennic.org/) or [OpenDNS](https://www.opendns.com/).</sub>
