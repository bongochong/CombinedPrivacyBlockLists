...
* [CPBL-ABP-List](abp:subscribe?location=https://raw.githubusercontent.com/bongochong/CombinedPrivacyBlockLists/master/CPBL-ABP-List.txt&title=Combined Privacy Block List for ABP & uBO): A simple filter subscription for AdBlock Plus and uBlock Origin, derived from [the standard compiled hosts file](https://github.com/bongochong/CombinedPrivacyBlockLists/blob/master/newhosts-final.hosts) in my repo. It works great.  
