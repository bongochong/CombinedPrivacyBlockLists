...
These lists *only* block ad, tracking, scam, telemetry, and malware servers. These lists *do not* block porn, social media, or so-called "fake news" domains, except for the ad, tracking, scam, telemetry, and malware servers associated with said sites. Any potential false positives are rigorously removed as well. Updates to all compiled lists usually occur around once a week, and sometimes more often.
