...
* [**cpbl-abp-list**](https://raw.githubusercontent.com/bongochong/CombinedPrivacyBlockLists/master/cpbl-abp-list.txt): Is a simple filter subscription for AdBlock Plus and uBlock Origin, derived from [the standard compiled hosts file](https://github.com/bongochong/CombinedPrivacyBlockLists/blob/master/newhosts-final.hosts) in my repo. It works great.
