...
curl -s "https://raw.githubusercontent.com/bongochong/CombinedPrivacyBlockLists/master/BLT/update-ipfilt.sh" -o update-ipfilt.sh
...
curl -s "https://raw.githubusercontent.com/bongochong/CombinedPrivacyBlockLists/master/BLT/parsing/wildcardwhitelist.dat" -o wildcardwhitelist.dat
cd ~/"$file_dir"/readmes
...
echo "perl wget pcregrep curl p7zip-full idn2 aggregate sipcalc or their equivalents"
echo "Enjoy!"
echo "..."
exit
else
