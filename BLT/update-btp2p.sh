...
mkdir -p ~/BLT/btp2p
cd ~/BLT/btp2p
rm -f level1BT.7z bt_level1.p2p level2BT.7z bt_level2.p2p combined.txt combined-final.p2p
...
cat *.p2p | sed "s/amp;//g" > combined.txt | sort | uniq -i > combined-final.p2p
sleep 1
...
rm -f level1BT.7z bt_level1.p2p level2BT.7z bt_level2.p2p combined.txt
xdg-open ~/BLT/btp2p
exit
