...
**Notes**:
- If you deviate from either of the checklists then you are being dumb. This does not apply if you are modifying the files as opposed to using them as is.
